    ...
    public class SoftEffectsFont : SoftEffects
    {
        ...
        public override void ApplyWorkMaterial(Material mat, bool disableComponent)
        {
            ...
            if (faceOptions.mainTexture)
            {
                ...
                {
                    AssetDatabase.DeleteAsset(AssetDatabase.GetAssetPath(faceOptions.mainTexture)); // 11.06.2026   FileUtil.DeleteFileOrDirectory(AssetDatabase.GetAssetPath(faceOptions.mainTexture));
                }
            }
